...
// Pattern represents a structured pattern for authorization
// with support for wildcards (*).
// A pattern is a colon separated list of components with well
// defined rules for determining if a request is allowed by a
// given requirement. Wildcards match entire pattern components and
