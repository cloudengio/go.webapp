...
func checkReadBodyErr(t *testing.T, err error, tt testCase) {
	t.Helper()
	if tt.wantErr {
		if err == nil {
...
func checkReadBodyOutput(t *testing.T, gotBody []byte, tt testCase) {
	t.Helper()
...
func checkReadBodyAfter(t *testing.T, req *http.Request, err error, tt testCase) {
	t.Helper()
...
func TestReadBodyLimit(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			checkReadBodyErr(t, err, tt)
			checkReadBodyOutput(t, gotBody, tt)
			checkReadBodyAfter(t, req, err, tt)
		})
	}
}
